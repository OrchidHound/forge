	...
	public void update() {
		...
		if (FModel.getQuest().getAchievements() != null) {
			...
			btnTest.addActionListener(e -> {
				...
				javax.swing.JMenuItem itemSpecialShop = new javax.swing.JMenuItem("Trigger Special Shop");
				...
				javax.swing.JMenuItem itemRelicOffer = new javax.swing.JMenuItem("Trigger Relic Offer");
				itemRelicOffer.addActionListener(ae -> {
					forge.gamemodes.quest.QuestUtil.performRelicOffer();
					FModel.getQuest().save();
					CSubmenuDuels.this.update();
				});
				testMenu.add(itemRelicOffer);
				...
				itemResetShop.addActionListener(ae -> { forge.gamemodes.quest.QuestSpellShop.clearSpecialShop(); CSubmenuDuels.this.update(); });
				testMenu.add(itemResetShop);
